          ...
          <v-img :src="posterPath" alt="" class=""/>
            ...
            <v-col cols="12" sm="8">
               ...
               <v-row>
                ...
                <div class="mt-5">
                    <h2 class="mt-5 grey--text text--darken-3">Feature Cast</h2>
            ...
            <!-- <v-divider class="mt-2"></v-divider>
                <Images :images="movie.image.backdrops" /> -->
      </v-container>
  </div>
</template>
...
methods: {
    async fetchMovie(movieId) {
        ...
        const response = await this.$http.get("/movie/" + movieId + "?" + (key) + "&append_to_response=credits,videos,images/");
